...
AS $$
  WITH recorded AS (
    ...
    FROM (VALUES
      ...
      ('MESH-SOL-TX-001', 'implemented', 'exact legacy and v0 messages, lookup validation, compute budget, SPL and ATA instructions, unsigned simulation, and byte-free reports'),
