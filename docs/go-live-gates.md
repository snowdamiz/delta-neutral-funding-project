...
| Native Solana read differential | PASS for bounded proofs | `scripts/check-native-solana-read.sh`; `scripts/check-native-solana-subscription.sh`; sustained replacement soak remains collecting |
