...
| 5. State machines, opportunity, and risk | In progress | Fail-closed lifecycles, source-gap/staleness breakers, reconciliation, authenticated controls, durable exits, emergency flattening, and a guarded CLI run; margin breakers remain |
