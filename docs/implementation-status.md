...
| 1. Financial correctness and Mesh slice | Complete | Checked fixed-point math, cross-boundary parsers, tests, and a compiled collector are pinned to Mesh `7cc1cfa` |
...
| 6. Replay and differential validation | In progress | Deterministic virtual-time replay validates ordering, duplicate keys, exact config/toolchain pins, dual portfolio decisions, and funding traces; CLI bundles and differential vectors remain |
