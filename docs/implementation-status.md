...
| 7. 30-day paper soak | Collecting on the fenced release | The failed schema-28 run beginning at `1785165668457` remains preserved with its 777,664 ms source gap. A fresh schema-31 qualification began at `1785193575453` on project `9e958f6`, Mesh `bea7d21`, and config `f30c522`; it must retain that real start time while collecting 30 days, 100 funding intervals, and at least two epoch transitions |
