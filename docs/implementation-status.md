...
| 1. Financial correctness and Mesh slice | Complete | Checked fixed-point math, cross-boundary parsers, runtime telemetry, tests, and a compiled collector are pinned to Mesh `2975955` |
