...
| 1. Financial correctness and Mesh slice | Complete | Checked fixed-point math, cross-boundary parsers, native Solana read and instruction-inspection packages, runtime telemetry, tests, and a compiled collector are pinned to Mesh `e612743` |
