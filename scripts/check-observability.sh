...
grep -q "funding_collector_build_info{app_commit=\"$app_commit\",mesh_compiler_commit=\"$mesh_commit\",mesh_runtime_commit=\"$mesh_commit\",adapter_commit=\"$app_commit\",executor_commit=\"$app_commit\",schema_version=\"45\",execution_mode=\"paper\"} 1" \
  "$metrics_file"
