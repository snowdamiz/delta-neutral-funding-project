...
fn bundle(config :: String, events :: List<String>) -> String do
  let manifest = "{\"replaySchemaVersion\":1,\"bundleId\":\"calm-v1\",\"configHash\":\"${Crypto.sha256(config)}\",\"meshCommit\":\"b07d37d07c6442590be24e656c6f1bd5f48c5500\"}"
...
describe("deterministic replay") do
  test("uses virtual event time and rejects look-ahead ordering") do
    ...
    case run_replay(config, bundle(config, events), "b07d37d07c6442590be24e656c6f1bd5f48c5500") do
      Ok(first) -> do
        case run_replay(config, bundle(config, events), "b07d37d07c6442590be24e656c6f1bd5f48c5500") do
          Ok(second) -> do
    ...
    case run_replay(
      ...
      "b07d37d07c6442590be24e656c6f1bd5f48c5500"
    ) do
