...
fn bundle(config :: String, events :: List<String>) -> String do
  let manifest = "{\"replaySchemaVersion\":1,\"bundleId\":\"calm-v1\",\"configHash\":\"${Crypto.sha256(config)}\",\"meshCommit\":\"29759556ec0c9298ad21c836aaee9c2a82c58b12\"}"
...
describe("deterministic replay") do
  test("uses virtual event time and rejects look-ahead ordering") do
    ...
    case run_replay(config, bundle(config, events), "29759556ec0c9298ad21c836aaee9c2a82c58b12") do
      Ok(first) -> do
        case run_replay(config, bundle(config, events), "29759556ec0c9298ad21c836aaee9c2a82c58b12") do
          Ok(second) -> do
