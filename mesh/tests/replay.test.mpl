...
fn bundle(config :: String, events :: List<String>) -> String do
  let manifest = "{\"replaySchemaVersion\":1,\"bundleId\":\"calm-v1\",\"configHash\":\"${Crypto.sha256(config)}\",\"meshCommit\":\"ed8dc2b8254ab51d4ebefed43fe4f4d44a128d2a\"}"
...
describe("deterministic replay") do
  test("uses virtual event time and rejects look-ahead ordering") do
    ...
    case run_replay(config, bundle(config, events), "ed8dc2b8254ab51d4ebefed43fe4f4d44a128d2a") do
      Ok(first) -> do
        case run_replay(config, bundle(config, events), "ed8dc2b8254ab51d4ebefed43fe4f4d44a128d2a") do
          Ok(second) -> do
    ...
    case run_replay(
      ...
      "ed8dc2b8254ab51d4ebefed43fe4f4d44a128d2a"
    ) do
