...
fn bundle(config :: String, events :: List<String>) -> String do
  let manifest = "{\"replaySchemaVersion\":1,\"bundleId\":\"calm-v1\",\"configHash\":\"${Crypto.sha256(config)}\",\"meshCommit\":\"61f406f33065169e750e06ab374b1aadeddefb61\"}"
...
describe("deterministic replay") do
  test("uses virtual event time and rejects look-ahead ordering") do
    ...
    case run_replay(config, bundle(config, events), "61f406f33065169e750e06ab374b1aadeddefb61") do
      Ok(first) -> do
        case run_replay(config, bundle(config, events), "61f406f33065169e750e06ab374b1aadeddefb61") do
          Ok(second) -> do
    ...
    case run_replay(
      ...
      "61f406f33065169e750e06ab374b1aadeddefb61"
    ) do
